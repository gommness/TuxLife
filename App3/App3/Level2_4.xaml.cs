...
namespace TuxLife
{
    ...
    /// </summary>
    public sealed partial class Level2_4 : Page
    {
        ...
        public Level2_4()
        {
            ...
            world.addActor(ply);
            world.addActor(new FlyingEnemy(sebastian, world));
            world.addActor(new FlyingEnemy(sebastian_Copy, world));
            world.addActor(new FlyingEnemy(sebastian_Copy1, world));
            world.addActor(new FlyingEnemy(sebastian_Copy2, world));
            world.addActor(new FlyingEnemy(sebastian_Copy3, world));
            world.addActor(new FlyingEnemy(sebastian_Copy4, world));
